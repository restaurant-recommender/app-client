...
function GroupStart({ id }) {
  ...
  return (
    <div className="container">
      ...
      <p>{f('group_desc')}</p>
      {items && <RestaurantListArea disabled={isSubmited} selectedCount={6} availableItems={items} selectedTitle={f('title_love')} setAvailableItemsCallback={setItemsCallback}/>}
      <Spacer height={100} />
